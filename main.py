...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value=""
        Entry(width=17,bg='#ccddff',font=("Arial Bold",28),textvariable=self.equation).place(x=0,y=0) #there should be a )
        ...
        Button(width=11,height=4,text="+",relief="flat",bg="lightblue",command=lambda:self.show("+")).place(x=270,y=275)
        Button(width=11,height=4,text="-",relief="flat",bg="lightgreen",command=lambda:self.show("-")).place(x=270,y=200)
        Button(width=11,height=4,text="/",relief="flat",bg="lightgreen",command=lambda:self.show("/")).place(x=270,y=50)
        Button(width=11,height=4,text="x",relief="flat",bg="lightblue",command=lambda:self.show("*")).place(x=270,y=125)
    ...
    def clear(self):
        self.entry_value=""
        self.equation.set(self.entry_value) #5:36
